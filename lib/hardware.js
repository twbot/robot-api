...
import properties from './hardware-properties';
...
class Hardware extends EventEmitter2 {
  ...
  constructor(robot) {
    ...
    this._resetHardwareLater = debounce(this._resetHardware, HARDWARE_TIMEOUT);

    this._battery = null;
    this._resetBatteryLater = debounce(this._resetBattery, BATTERY_TIMEOUT);

    this._ebuttons = null;
    this._resetEbuttonsLater = debounce(this._resetEbuttons, EBUTTONS_TIMEOUT);
